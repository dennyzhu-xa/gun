var UIApp = function () {
	...
	if(this.JSON){		//{"days": ["日", "一", "二", "三", "四", "五", "六","日"],"daysShort": ["日", "一", "二", "三", "四", "五", "六","日"],"daysMin": ["日", "一", "二", "三", "四", "五", "六","日"],"months": ["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],"monthsShort": ["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],"today": "今日"}
    ...
    var handleWidgetSubTools = function () {
        jQuery('.widget-sub .tools .icon-remove').click(function () {
            jQuery(this).parents(".widget-sub").parent().remove();
        });

        jQuery('.widget-sub .tools .icon-refresh').click(function () {
            var el = jQuery(this).parents(".widget-sub");
            UIApp.blockUI(el);
            window.setTimeout(function () {
                UIApp.unblockUI(el);
            }, 1000);
        ...
        jQuery('.widget-sub .tools .icon-arrow-up, .widget-sub .tools .icon-arrow-down').click(function () {
            var el = jQuery(this).parents(".widget-sub").children(".widget-body");
            if (jQuery(this).hasClass("icon-arrow-up")) {
                jQuery(this).removeClass("icon-arrow-up").addClass("icon-arrow-down");
                el.slideUp(200);
            } else {
                jQuery(this).removeClass("icon-arrow-down").addClass("icon-arrow-up");
                el.slideDown(200);
            }
        });
    }
        ...
        for (var i = 0; i < menuids.length; i++) {
          ...
          for (var t = 0; t < ultags.length; t++) {
            ...
            if($this.children('li').length > maxmenulength) {
              ...
              var up_btn = $('<li class="vertical-dropdown menu-control"><a href="javascript:;" ><i class="icon-angle-up"></i></a></li>'),
                down_btn = $('<li class="vertical-dropdown menu-control"><a href="javascript:;"><i class="icon-angle-down"></i></a></li>');
