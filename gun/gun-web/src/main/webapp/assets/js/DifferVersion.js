(function () {//alert("DifferVersion.js called!!");
    ...
    diff_match_patch.prototype.diff_bisect_ = function (a, b, c) {
        ...
        for (var k = d - e, q = 0 != k % 2, r = 0, t = 0, p = 0, w = 0, v = 0; v < f && !((new Date).getTime() > c) ; v++) {
            for (var n = -v + r; n <= v - t; n += 2) {
                var l = g + n, m; m = n == -v || n != v && j[l - 1] < j[l + 1] ? j[l + 1] : j[l - 1] + 1;
        ...
        for (f = 1; f < a.length;) {
            if (-1 == a[f - 1][0] && 1 == a[f][0]) {
                ...
                if (d >= e) {
                    ...
                    a[f + 1][0] = -1, a[f + 1][1] = b.substring(e),
                    f++;
                f++
            }
            f++
    ...
    diff_match_patch.prototype.diff_cleanupEfficiency = function (a) {
        for (var b = !1, c = [], d = 0, e = null, f = 0, g = !1, h = !1, j = !1, i = !1; f < a.length;) {
            if (0 == a[f][0])
                a[f][1].length < this.Diff_EditCost && (j || i) ? (c[d++] = f, g = j, h = i, e = a[f][1]) : (d = 0, e = null),
                j = i = !1;
        ...
        for (var b = 0, c = 0, d = 0, e = "", f = "", g; b < a.length;)
            switch (a[b][0]) {
                ...
                case -1:
                    ...
                    break;
                case 0:
                    1 < c + d ? (0 !== c && 0 !== d && (g = this.diff_commonPrefix(f, e), 0 !== g && (0 < b - c - d && 0 == a[b - c - d - 1][0] ? a[b - c - d - 1][1] += f.substring(0, g) : (a.splice(0, 0, [0, f.substring(0, g)]), b++),
                    f = f.substring(g),
                    e = e.substring(g)),
                    ...
                    b = b - c - d + (c ? 1 : 0) + (d ? 1 : 0) + 1) : 0 !== b && 0 == a[b - 1][0] ? (a[b - 1][1] += a[b][1], a.splice(b, 1)) : b++,
                    c = d = 0,
                    f = e = ""
            }
    ...
    diff_match_patch.prototype.diff_prettyHtml = function (a) {
        for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0; g < a.length; g++) {
            ...
            switch (h) {
                case 1:
                    b[g] = '<ins style="color: #0000FF">' + j + "</ins>";
                    break; case -1:
                        b[g] = '<del style="color: #FF0000">' + j + "</del>";
                        break;
                case 0:
                    b[g] = "<span>" + j + "</span>"
            }
    ...
    diff_match_patch.prototype.patch_make = function (a, b, c) {
        ...
        for (var e = 0, f = 0, g = 0, h = d, j = 0; j < b.length; j++) {
            var i = b[j][0], k = b[j][1]; !e && 0 !== i && (a.start1 = f, a.start2 = g);
            switch (i) {
                case 1:
                    a.diffs[e++] = b[j];
                    ...
                    break;
                case -1:
                    a.length1 += k.length; a.diffs[e++] = b[j]; d = d.substring(0, g) + d.substring(g + k.length);
                    break;
                case 0:
        ...
        for (var b = this.Match_MaxBits, c = 0; c < a.length; c++)
            if (!(a[c].length1 <= b)) {
                ...
                for (var e = d.start1, f = d.start2, g = ""; 0 !== d.diffs.length;) {
                    ...
                    h.start1 = e - g.length; h.start2 = f - g.length;
                    ...
                    for (; 0 !== d.diffs.length && h.length1 < b - this.Patch_Margin;) {
                        ...
                        1 === g ? (h.length2 += i.length, f += i.length, h.diffs.push(d.diffs.shift()), j = !1) : -1 === g && 1 == h.diffs.length && 0 == h.diffs[0][0] && i.length > 2 * b ? (h.length1 += i.length, e += i.length, j = !1, h.diffs.push([g, i]), d.diffs.shift()) : (i = i.substring(0, b - h.length1 - this.Patch_Margin),
                        h.length1 += i.length,
                        e += i.length,
    ...
    diff_match_patch.prototype.patch_fromText = function (a) {
        ...
        for (var c = 0, d = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; c < a.length;) {
            ...
            b.push(f); f.start1 = parseInt(e[1], 10);
            "" === e[2] ? (f.start1--, f.length1 = 1) : "0" == e[2] ? f.length1 = 0 : (f.start1--, f.length1 = parseInt(e[2], 10));
            f.start2 = parseInt(e[3], 10); "" === e[4] ? (f.start2--, f.length2 = 1) : "0" == e[4] ? f.length2 = 0 : (f.start2--, f.length2 = parseInt(e[4], 10));
            for (c++; c < a.length;) {
                e = a[c].charAt(0);
                try {
...
function fnDifferVersion(pStringOld, pStringNew, objBoxID) {
    var dmp = new diff_match_patch();
    dmp.Diff_Timeout = parseFloat(1);
    dmp.Diff_EditCost = parseFloat(4);
    var strDiff = dmp.diff_main(pStringOld, pStringNew);
    var htmDiff = dmp.diff_prettyHtml(strDiff);
    htmDiff = htmDiff.replace(/##$$;;/g, "\"");//�r��ǤJ�e�i����޸��r�Ū������A�b����r������^�ӡC
//    var objBox = document.getElementById(objBoxID);
//    if (objBox != null)
//        objBox.innerHTML = htmDiff;
    objBoxID.innerHTML = htmDiff;
}